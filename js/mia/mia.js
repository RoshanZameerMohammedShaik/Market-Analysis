...
const ACTION_VERBS = {
    ...
    open_pl_panel: 'opening the P&L panel',
    close_pl_panel: 'closing the P&L panel',
    toggle_engine_signals: 'toggling engine signals on the chart',
    open_trade_modal: 'opening the trade ticket',
